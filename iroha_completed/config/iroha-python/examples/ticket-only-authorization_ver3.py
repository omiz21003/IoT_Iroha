...
def get_account_tagid_assets():
    ...
    file.close()
    print(f'concealed_tag_ids')
    print(concealed_tag_ids)
    print(f'disclosed_tag_ids')
    print(disclosed_tag_ids)
    #ng_tag_ids=['image','thermography','human']
    #ok_tag_ids=['temp','humid','light','fire','smoke','vibration']
       ...
       for s_domain in domain_list:
        ...
        for asset in data:
         ...
         if '999.00' in asset_balance_list:
             print(f'There are some tickets!')
         else:
             print(f'no ticket')
         print(concealed_tag_ids)
         print(f'ticket_id')
         ...
         i=0
         j=len(disclosed_tag_ids)+len(concealed_tag_ids)
         while i!=j-1:
          if concealed_tag_ids[c] in asset.asset_id : #search concealed_tag_id
            print(f'Where is the imposeter')
            print(u_id+'@'+s_domain)
            ...
            if s_domain != domain: #check the domain. if the domain was yours, you'll send your data
                ...
                #transfer_coin('admin@test', u_id+'@'+s_domain, asset.asset_id)
            else:
