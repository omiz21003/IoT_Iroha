...
def get_account_assets(account_id: str):
    ...
    for asset in data:
        ...
        print(f'get account_asset info!')
...
def query_transactions(first_time=None, last_time=None,
    ...
    response = net.send_query(query)
    data = response
    print(f'I will show you detail')
    print(data)
