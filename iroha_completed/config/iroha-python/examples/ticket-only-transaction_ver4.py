...
# Here we will create user keys in original
...
if __name__ == '__main__':
    try:
        ticket_list=['temphumidsmoke3','temphumidvibration2','templightfire2','templightsmoke2','templightvibration2','tempfiresmoke2','tempfirevibration2','tempsmokevibration2','humidlightfire2','humidlightsmoke2','humidlightvibration2','humidfiresmoke2','humidfirevibration2','humidsmokevibration2','lightfiresmoke2','lightfirevibration2','lightsmokevibration2','firesmokevibration2','temphumidlightfire2','temphumidlightsmoke2','temphumidlightvibration2','temphumidfiresmoke2','temphumidfirevibration2','temphumidsmokevibration2','humidlightfiresmoke2','humidlightfirevibration2','humidlightsmokevibration2']
        for ticket_id in ticket_list:
         create_ticket(domain='CR', tag_id= ticket_id)
         add_coin_to_admin(tag_id=ticket_id+'#CR')
         transfer_coin('admin@test', 'sfn1@CR', ticket_id+'#CR')
         get_coin_info(tag_id=ticket_id+'#CR')
         time.sleep(3)
